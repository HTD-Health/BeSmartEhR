...
exports.fieldTypesMapping = void 0;
exports.fieldTypesMapping = {
    ...
    choice: (item) => {
        ...
        for (const option of item.answerOption) {
            ...
            const prefixExtension = (_a = option.extension) === null || _a === void 0 ? void 0 : _a.find(extension => extension.url === 'http://hl7.org/fhir/StructureDefinition/questionnaire-optionPrefix');
