...
const generateUISchemaItem = (item) => {
    ...
    const unitExtension = (_a = item.extension) === null || _a === void 0 ? void 0 : _a.find(extension => extension.url === 'http://hl7.org/fhir/StructureDefinition/questionnaire-unit');
    if (unitExtension) {
    ...
    if (item.item) {
        ...
        for (const display of displays) {
            const displayExtension = (_d = display.extension) === null || _d === void 0 ? void 0 : _d.find(e => e.url === 'http://hl7.org/fhir/StructureDefinition/questionnaire-itemControl');
